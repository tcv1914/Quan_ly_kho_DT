...
INSERT INTO `khachhang` (`makh`, `tenkhachhang`, `diachi`, `sdt`, `email`, `trangthai`, `ngaythamgia`) VALUES
...
--
-- Add column for email (for existing databases)
--
ALTER TABLE `khachhang`
  ADD COLUMN `email` varchar(255) NOT NULL DEFAULT '' AFTER `sdt`;
