...
public class KhachHangDTO {
    ...
    public KhachHangDTO(int maKH, String hoten, String sdt, String diachi, String email) {
        this.maKH = maKH;
        this.hoten = hoten;
        this.sdt = sdt;
        this.diachi = diachi;
    ...
    public KhachHangDTO(int maKH, String hoten, String sdt, String diachi, String email, Date ngaythamgia) {
        this.maKH = maKH;
        this.hoten = hoten;
        this.sdt = sdt;
        this.diachi = diachi;
    ...
    public String toString() {
        return "KhachHang{" + "maKH=" + maKH + ", hoten=" + hoten + ", sdt=" + sdt + ", diachi=" + diachi + ", email=" + email + '}';
    }
