...
public final class PhieuXuat extends JPanel implements ActionListener, KeyListener, PropertyChangeListener, ItemListener {
    ...
    private void initComponent() {
        ...
        String[] action = {"create", "detail", "print", "cancel", "export"};
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        } else if (source == mainFunction.btn.get("print")) {
            if (getRow() < 0) {
                JOptionPane.showMessageDialog(null, "Vui lòng chọn phiếu cần in!");
            } else {
                writePDF w = new writePDF();
                w.writePX(pxBUS.getSelect(getRow()).getMaphieu());
            }
